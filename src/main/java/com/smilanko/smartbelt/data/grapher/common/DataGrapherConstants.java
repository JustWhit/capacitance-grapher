...
public class DataGrapherConstants {
	...
	public static final String SET_END = "SET END";
	public static final String LIFT_START = "LIFT START";
	public static final String LIFT_PEAK = "LIFT PEAK";
	public static final String LIFT_REST = "LIFT REST";
